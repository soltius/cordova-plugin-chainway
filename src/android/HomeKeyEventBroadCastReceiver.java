...
class HomeKeyEventBroadCastReceiver extends BroadcastReceiver {
  ...
  public HomeKeyEventBroadCastReceiver(CordovaInterface cordova, CallbackContext callbackContext) {
    ...
    // Toast.makeText(cordova.getActivity(), "new HomeKeyEventBroadCastReceiver", Toast.LENGTH_SHORT).show();
  }

  @Override
  public void onReceive(Context context, Intent intent) {
    // Toast.makeText(cordova.getActivity(), "onReceive", Toast.LENGTH_SHORT).show();
